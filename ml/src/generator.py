...
ВАЖНО: Если контекст относится к другому типу рака (нозологии), установи is_compliant: false и объясни, почему не применимо. Используй только релевантные источники.
"""
